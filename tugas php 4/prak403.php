    ...
    <?php
        ...
        for ($i=0; $i<count($nilai); $i++) {
            ...
            for ($j=0; $j<count($nilai[$i]["matkul"]); $j++) { 
                ...
                if ($j == 0) {
                    echo "<td rowspan='".count($nilai[$i]["matkul"])."'>".$total_sks."</td>";
                    echo "<td rowspan='".count($nilai[$i]["matkul"])."'>";
                    if($nilai[$i]["keterangan"]=="Revisi KRS"){
                        echo "<span style='background-color:red'>".$nilai[$i]["keterangan"]."</span>";                        
                    }
                    else{
                        echo "<span style='background-color:green'>".$nilai[$i]["keterangan"]."</span>"; 
                    }
                    echo "</td>";
                }
                echo "</tr>";
